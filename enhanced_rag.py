#!/usr/bin/env python3
"""
Enhanced RAG system that uses both your notes AND the LLM's pre-trained knowledge
"""
...
class EnhancedRAG:
 def __init__(self, subject="your subject"):
     print(f"Initializing Enhanced RAG System for {subject}...")
     ...
     self.vectorstore_file = f"enhanced_vectorstore_{subject.replace(' ', '_').lower()}.json"
...
Please provide a clear, comprehensive answer about {self.subject} concepts:"""
 ...
 def interactive_mode(self):
     ...
     print("\n" + "="*70)
     print(f" ENHANCED {self.subject.upper()} STUDY ASSISTANT")
     print("="*70)
     print("This system uses BOTH your notes AND the LLM's knowledge!")
 ...
 def show_help(self):
     ...
     if "computer architecture" in self.subject.lower():
         examples = [
             "What did I learn about S'R' latches in Lab 03?",
             "Explain the concepts from Section 1.1 about computer architecture",
             "What was the homework about in HW01?",
             "How do the lab instructions explain pipelining?",
             "What are the key points from the zyBooks sections?",
             "Explain memory hierarchy concepts",
             "What did I learn about instruction set architecture?",
             "How does cache memory work in general?",
...
def main():
 ...
 print(" Welcome to the Enhanced RAG Study Assistant!")
